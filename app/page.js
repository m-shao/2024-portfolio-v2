...
export default function Home() {
    ...
    return (
        <div className="flex justify-center items-center h-screen w-screen flex-col">
            {/* <div className="w-1 h-1 rounded-full absolute bg-red-400 z-50" style={{top:`${center[0].y}px`,left:`${center[0].x}px`}}></div>
            <div className="w-1 h-1 rounded-full absolute bg-red-400 z-50" style={{top:`${center[1].y}px`,left:`${center[1].x}px`}}></div>
            <div className="w-1 h-1 rounded-full absolute bg-red-400 z-50" style={{top:`${center[2].y}px`,left:`${center[2].x}px`}}></div>
            <div className="w-1 h-1 rounded-full absolute bg-red-400 z-50" style={{top:`${center[3].y}px`,left:`${center[3].x}px`}}></div> */}
            <nav className="flex justify-center gap-20 font-sans font-normal py-12 text-2xl text-primary">
                <Link href={'#'} className="group">
                    <p>/Home</p>
                    <div className="w-0 group-hover:w-full bg-text h-[1px] transition-all"></div>
                </Link>
                <Link href={'#'} className="group">
                    <p>/About</p>
                    <div className="w-0 group-hover:w-full bg-text h-[1px] transition-all"></div>
            ...
            <main className="flex-1 flex justify-center items-center pb-96">
